export default {
  ...
  setup: {
    ...
    previewBreakdown: 'Budget breakdown',
  ...
  settings: {
    ...
    budgetSplitScope: 'Applies to all 12 months of {year}.',
    budgetSplitTotal: 'Total: {total}%',
    budgetSplitInvalid: 'Total {total}% · must be 100%',
    budgetSplitUpdated: 'Split updated',
    budgetSplitError: 'Could not update the split.',
    data: 'Data & backup',
    about: 'Triada · your data stays on this device only',
  },
  nav: {
